...
- (void)windowDidResize:(NSNotification *)notification
{
    ...
    searchRect.origin.y = NSHeight([self.backgroundView bounds]) - self.backgroundView.arrowHeight - SEARCH_INSET - NSHeight(searchRect);
    ...
    textRect.size.height = NSHeight([self.backgroundView bounds]) - self.backgroundView.arrowHeight - SEARCH_INSET * 3 - NSHeight(searchRect);
...
- (NSRect)statusRectForWindow:(NSWindow *)window
{
    ...
    {
        statusRect.size = NSMakeSize([self.delegate statusItemViewWidth], [[NSStatusBar systemStatusBar] thickness]);
...
- (void)openPanel
{
    ...
    if (NSMaxX(panelRect) > (NSMaxX(screenRect) - self.backgroundView.arrowHeight))
        panelRect.origin.x -= NSMaxX(panelRect) - (NSMaxX(screenRect) - self.backgroundView.arrowHeight);
